...
import com.bank.prl.payload.request.config.jwt.JwtUtil;
import com.bank.prl.payload.request.dao.UserDAO;
import com.bank.prl.payload.request.model.Role;
import com.bank.prl.payload.request.model.User;
import com.bank.prl.payload.request.model.UserRole;
import com.bank.prl.payload.request.payload.request.LoginForm;
import com.bank.prl.payload.request.payload.request.SignUpForm;
import com.bank.prl.payload.request.payload.response.LoginResponse;
import com.bank.prl.payload.request.payload.response.Response;
import com.bank.prl.payload.request.repository.RoleRepo;
